...
- (void)startWithOptions:(NSDictionary *)options
{
    ...
    [ijkOptions setPlayerOptionIntValue:30  forKey:@"max-fps"];
    ...
    [ijkOptions setCodecOptionIntValue:8 forKey:@"skip_frame"];
    [ijkOptions setFormatOptionValue:@"nobuffer" forKey:@"fflags"];
